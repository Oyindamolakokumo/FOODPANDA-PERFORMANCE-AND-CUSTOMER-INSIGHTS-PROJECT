# FOODPANDA PERFORMANCE AND CUSTOMER INSIGHTS PROJECT
...
2. Data Modeling
Built relationships between key tables (orders, customers, restaurants)
Created calculated columns and measures using DAX
3. Data Analysis
Performed exploratory analysis to identify trends and patterns
Analyzed KPIs such as revenue, churn rate, and delivery performance
4. Data Visualization
Designed interactive dashboards in Power BI
Used filters, slicers, and drill-down features for deeper insights
5. Insight Generation
Translated data findings into business insights
Developed actionable recommendations

### **Key Highlights**
*  Total Revenue: Rs 14.34M
*  Total Orders: ~18K
*  Customers: ~6K
*  Churn Rate: 49%
